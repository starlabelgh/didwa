              ...
              <?php
                ...
                <div class="col-md-6">
                  <ul class="list-group">
                    ...
                    <li class="list-group-item"><b>Cost Price</b>  :<span class="label label-warning pull-right">GH₵ <?php echo number_format($row->purchase_price); ?></span></li>
                    <li class="list-group-item"><b>Selling price</b>     :<span class="label label-warning pull-right">GH₵ <?php echo $row->sell_price; ?></span></li>
                    <li class="list-group-item"><b>Profit Margin</b>           :<span class="label label-success pull-right">GH₵ <?php echo number_format(($row->sell_price - $row->purchase_price)); ?></span></li>
                    <li class="list-group-item"><b>Stock </b>          :<span class="label label-default pull-right"><?php echo $row->stock; ?></span></li>
                    <li class="list-group-item"><b>Minimum Inventory </b>   :<span class="label label-default pull-right"><?php echo $row->min_stock; ?></span></li>
