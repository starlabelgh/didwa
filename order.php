<?php
    ...
    $delete = $pdo->prepare("DELETE FROM tbl_invoice WHERE invoice_id=".$id);
    
    // $delete = $pdo->prepare("DELETE FROM tbl_invoice , tbl_invoice_detail FROM tbl_invoice INNER JOIN tbl_invoice_detail ON tbl_invoice.invoice_id = tbl_invoice_detail.invoice_id WHERE tbl_invoice.invoice_id=$id");
                    ...
                    <table class="table table-striped" id="myOrder">
                        ...
                        <tbody>
                            ...
                            ?>
                                ...
                                <td>GH₵ <?php echo number_format($row->delivery); ?></td>
                                <td>
                                    <a href="edit_order.php?id=<?php echo $row->product_id; ?>" class="btn btn-info btn-sm"><i class="fa fa-pencil"></i></a>
